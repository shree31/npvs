...
public class MtAgnNewsPaperMap {
	@Id
	@GeneratedValue
	...
	@Column(name = "pubDay1")
	private String pubDay1;
	@Column(name = "pubDay2")
	private String pubDay2;
	@Column(name = "pubDT")
	...
	public String getAvdCoupon() {
		return avdCoupon;
	}
	public void setAvdCoupon(String avdCoupon) {
	...
	public String getPubDay1() {
		return pubDay1;
	}
	public void setPubDay1(String pubDay1) {
		this.pubDay1 = pubDay1;
	}
	public String getPubDay2() {
		return pubDay2;
	}
	public void setPubDay2(String pubDay2) {
