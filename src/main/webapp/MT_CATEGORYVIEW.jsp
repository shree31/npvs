...
<%	
	...
	String formName = "MT_CATEGORYVIEW";
...
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_CATEGORYVIEW">
 ...
 <TABLE class="detailstable" cellspacing="0" cellpadding="0">
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="1" nowrap>
			<INPUT type="text" id="CTG_CODE" name="CTG_CODE" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('CTG_CODE','CTG_NAME', 'g_pkl_category','')" maxLength="10"  value="<%= (String)MT_CATEGORYObj.get("CTG_CODE") %>" >
