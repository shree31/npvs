...
<%	
	...
	String formName = "MT_COMMISSIONVIEW";
...
<INPUT type="hidden" id="PRIMARY_KEY" name="PRIMARY_KEY" value="PUB_CODE#COMM_CODE">
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_COMMISSIONVIEW">
<INPUT type="hidden" id="ERRDESC" name="ERRDESC" value="<%= (String)MT_COMMISSIONObj.get("ERRDESC") %>">
 ...
 <TABLE class="detailstable" cellspacing="0" cellpadding="0">
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="7" nowrap>
			<INPUT type="text" id="PUB_CODE" name="PUB_CODE" class="input" size="10" readOnly onChange="FieldValidation(this);getCodeDesc('PUB_CODE,CMP_CODE','PUB_CODEDESC', 'g_pkl_publicationDesc','');" maxLength="10"  value="<%= (String)MT_COMMISSIONObj.get("PUB_CODE") %>" >
...
<!--
	<TR class="ste">
		...
		<TD class="ste" colspan="7" nowrap>
			<INPUT type="text" id="EDT_CODE" name="EDT_CODE" class="input" size="30" readonly onChange="FieldValidation(this);getCodeDesc('EDT_CODE,CMP_CODE,PUB_CODE,USER_ID','EDT_CODEDESC', 'g_pkl_editionDesc','');" maxLength="30"  value="<%= (String)MT_COMMISSIONObj.get("EDT_CODE") %>" >
...
-->
	<TR class="ste">
		...
		<TD class="ste" colspan="7" nowrap>
			<INPUT type="text" id="COMM_CODE" name="COMM_CODE" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('COMM_CODE,PUB_CODE','COMM_NAME', 'g_pkl_commissionDesc','');" maxLength="10"  value="<%= (String)MT_COMMISSIONObj.get("COMM_CODE") %>" >
			<A id="COMM_CODEHLP" name="COMM_CODEHLP"  href="#" onClick="getPicklistValues('g_pkl_commission','COMM_CODE','PUB_CODE','')" class="linkblue" >?</A> &nbsp;
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="COMM_NAME_label" class="userlabel"><%= field_labels.getString("MT_COMMISSION.NAME") %><SPAN class="instreditalic">*</SPAN></LABEL>
		</TD>
		<TD class="ste" colspan="7" nowrap>
	...
	<TR class="ste">
		...
		<TD class="ste" nowrap>
			<INPUT type="text" id="COMM_MON" name="COMM_MON" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("COMM_MON") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="COMM_TUE" name="COMM_TUE" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("COMM_TUE") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="COMM_WED" name="COMM_WED" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("COMM_WED") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="COMM_THU" name="COMM_THU" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("COMM_THU") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="COMM_FRI" name="COMM_FRI" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("COMM_FRI") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="COMM_SAT" name="COMM_SAT" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("COMM_SAT") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="COMM_SUN" name="COMM_SUN" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("COMM_SUN") %>" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
		...
		<TD class="ste" nowrap>
			<INPUT type="text" id="ADD_COMM_MON" name="ADD_COMM_MON" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("ADD_COMM_MON") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="ADD_COMM_TUE" name="ADD_COMM_TUE" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("ADD_COMM_TUE") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="ADD_COMM_WED" name="ADD_COMM_WED" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("ADD_COMM_WED") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="ADD_COMM_THU" name="ADD_COMM_THU" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("ADD_COMM_THU") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="ADD_COMM_FRI" name="ADD_COMM_FRI" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("ADD_COMM_FRI") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="ADD_COMM_SAT" name="ADD_COMM_SAT" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("ADD_COMM_SAT") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="ADD_COMM_SUN" name="ADD_COMM_SUN" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("ADD_COMM_SUN") %>" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
		...
		<TD class="ste" nowrap>
			<INPUT type="text" id="INC_MON" name="INC_MON" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INC_MON") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INC_TUE" name="INC_TUE" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INC_TUE") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INC_WED" name="INC_WED" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INC_WED") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INC_THU" name="INC_THU" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INC_THU") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INC_FRI" name="INC_FRI" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INC_FRI") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INC_SAT" name="INC_SAT" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INC_SAT") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INC_SUN" name="INC_SUN" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INC_SUN") %>" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
		...
		<TD class="ste" nowrap>
			<INPUT type="text" id="INS_MON" name="INS_MON" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INS_MON") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INS_TUE" name="INS_TUE" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INS_TUE") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INS_WED" name="INS_WED" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INS_WED") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INS_THU" name="INS_THU" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INS_THU") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INS_FRI" name="INS_FRI" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INS_FRI") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INS_SAT" name="INS_SAT" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INS_SAT") %>" >
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="INS_SUN" name="INS_SUN" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_COMMISSIONObj.get("INS_SUN") %>" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
