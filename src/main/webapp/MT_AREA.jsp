...
{
	document.getElementById("PRIMARY_KEY").value = "RGN_CODE";
...
<INPUT type="hidden" id="ENTITY" name="ENTITY" value="MT_AREA">
...
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_AREA">
 ...
 <TABLE class="detailstable" cellspacing="0" cellpadding="0">
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="AREA_CODE" name="AREA_CODE" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_AREAObj.get("AREA_CODE") %>" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
	...
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="MAR_NAME_label" class="userlabel"><%= field_labels.getString("MT_AREA.MAR_NAME") %></LABEL>
		</TD>
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="MAR_NAME" name="MAR_NAME" class="marathi_script" size="60" onblur="FieldValidation(this);" maxLength="60"  value="<%= (String)MT_AREAObj.get("MAR_NAME") %>" >
		</TD>
	</TR>
<!--	<TR class="ste">
		<TD class="ste" nowrap>   
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="RGN_CODE" name="RGN_CODE" class="input" size="10" onChange="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_AREAObj.get("RGN_CODE") %>" >
	...
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="AREA_MNGR_label" class="userlabel"><%= field_labels.getString("MT_AREA.AM_CODE") %>
		</TD>
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="AREA_MNGR" name="AREA_MNGR" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('AREA_MNGR','AREA_MAR_NAME', 'g_pkl_AreaMngrDesc','EXEC_CODE');" maxLength="10"  value="<%= (String)MT_AREAObj.get("AREA_MNGR") %>" >

	  <INPUT type="text" id="AREA_MAR_NAME" name="AREA_MAR_NAME" class="input" size="50" readonly  maxLength="50" value="<%= 
	(String)MT_AREAObj.get("AREA_MAR_NAME") %>" >
