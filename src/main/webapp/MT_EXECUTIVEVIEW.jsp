...
<%	
	...
	String formName = "MT_EXECUTIVEVIEW";
...
<INPUT type="hidden" id="PRIMARY_KEY" name="PRIMARY_KEY" value="E.EXEC_CODE">
...
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_EXECUTIVEVIEW">
 ...
 <TABLE class="detailstable" cellspacing="0" cellpadding="0">
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="EXEC_CODE" name="EXEC_CODE" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('EXEC_CODE','NAME','g_pkl_executiveDesc','');" maxLength="10"  value="<%= (String)MT_EXECUTIVEObj.get("EXEC_CODE") %>" >
			<A id="EXEC_CODEHLP" name="EXEC_CODEHLP"  href="#" onClick="getPicklistValues('g_pkl_executive','EXEC_CODE','','')" class="linkblue" >?</A> &nbsp;
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
...
<!--	<TR class="ste">
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="AM_CODE" name="AM_CODE" class="input" size="10" onblur="FieldValidation(this);getCodeDesc('AM_CODE','AM_CODEDESC', 'g_pkl_AreaMngrDesc','');" maxLength="10"  value="<%= (String)MT_EXECUTIVEObj.get("AM_CODE") %>" >
...
<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="RM_CODE" name="RM_CODE" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('RM_CODE','RM_CODEDESC', 'g_pkl_RegionMngrDesc','');" maxLength="10"  value="<%= (String)MT_EXECUTIVEObj.get("RM_CODE") %>" >
...
<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="ZM_CODE" name="ZM_CODE" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('ZM_CODE','ZM_CODEDESC', 'g_pkl_ZoneMngrDesc','');" maxLength="10"  value="<%=(String)MT_EXECUTIVEObj.get("ZM_CODE")%>">
