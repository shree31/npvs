...
{
	clearNull();
	document.getElementById("PUB_TYPE").value = "N";
	document.getElementById("PUB_RUN").value = "D";
	getCodeDesc('PUB_TYPE','PUB_TYPEDESC', 'g_pkl_pubtypeDesc','KEY_CODE');
	getCodeDesc('PUB_RUN','PUB_RUNDESC', 'g_pkl_pubruntypeDesc','KEY_CODE');
	...
	document.getElementById("CITY").value="MU";
	document.getElementById("PUB_ADD_PIN").parentElement.parentElement.style.display="none";
		if(("<%=g_base_sup_flag%>" == "N"))
		document.getElementById("PUB_BASE_SUP").parentElement.parentElement.style.display="none";
...
if(document.getElementById("ERRDESC").value=="SUCCESS")
	{
		if(true == confirm('Do You Want to Add Rate?'))
		{
			gotoRate();
		}

		//document.getElementById("GotoRate").style.display='block';
...
{
	var l_numeric_flds = "PUB_PRODDAYSBEF,PUB_GUTTER,PUB_SIZEHEIGHT,PUB_NOOFCOLS,PUB_SIZEWIDTH,PUB_BASE_SUP";
...
function gotoRate() {
		window.open("MT_RATE.jsp?MODE=MOD&PUB_CODE="+document.getElementById("PUB_CODE").value+"","AddRate","height=550, width=1100");
		//document.forms[0].target="_self";
}

function gotoPurRate() {
		window.open("MT_PURRATE.jsp?MODE=MOD&PUB_CODE="+document.getElementById("PUB_CODE").value+"","AddRate","height=550, width=1100");
		//document.forms[0].target="_self";
}

function gotoSupRate() {
		window.open("MT_SUPCHRGADD.jsp?MODE=MOD&PUB_CODE="+document.getElementById("PUB_CODE").value+"","AddRate","height=550, width=1100");
		//document.forms[0].target="_self";
}
</SCRIPT>
...
<INPUT type="hidden" id="CREATION_DT" name="CREATION_DT" value="<%= (java.util.Date)MT_PUBLICATIONObj.get("CREATION_DT") %>">
<INPUT type="hidden" id="MAKER" name="MAKER" value="<%= (String)MT_PUBLICATIONObj.get("MAKER") %>">
<INPUT type="hidden" id="MAKER_DT" name="MAKER_DT" value="<%= (java.util.Date)MT_PUBLICATIONObj.get("MAKER_DT")%>">
...
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_PUBLICATION">
<INPUT type="hidden" id="ERRDESC" name="ERRDESC" value="<%=(String)MT_PUBLICATIONObj.get("ERRDESC")%>">
<INPUT type="hidden" id="COUPON_COPY_FLAG" name="COUPON_COPY_FLAG" value="N">
 ...
 <TABLE class="detailstable" cellspacing="0" cellpadding="0">
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="6" nowrap>
			<INPUT type="text" id="PUB_CODE" name="PUB_CODE" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_PUBLICATIONObj.get("PUB_CODE") %>" >
		</TD>
			</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="PUB_NAME" name="PUB_NAME" class="input" size="50" onblur="FieldValidation(this);" maxLength="65"  value="<%= (String)MT_PUBLICATIONObj.get("PUB_NAME") %>" >
		</TD>
		<TD class="ste" nowrap>   
	...
	<SELECT class="input"name='DIST_CD' id="DIST_CD" onChange="FieldValidation(this);getCodeDesc('DIST_CD','DIST_CDDESC', 'g_pkl_DistDesc','');"  onBlur="FieldValidation(this);">
		...
		%>
           	  ...
           	  <INPUT type="text" id="DIST_CDDESC" name="DIST_CDDESC" class="input" size="50" readonly  maxLength="50" value="<%=	(String)MT_PUBLICATIONObj.get("DIST_CDDESC")%>">
		</TD>
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="PUB_OLD_CODE" name="PUB_OLD_CODE" class="input" size="65" onblur="FieldValidation(this);" maxLength="65"  value="<%= (String)MT_PUBLICATIONObj.get("PUB_OLD_CODE") %>" >
		</TD>
			<TD class="ste" nowrap>   
	...
	<SELECT class="input"name='PUB_LANG' id="PUB_LANG" onChange="FieldValidation(this);getCodeDesc('PUB_LANG','PUB_LANGDESC', 'g_pkl_languagueDesc','KEY_CODE');"  onBlur="FieldValidation(this);">
		<%
			...
			out.println("<option value=''>Select</option>");
			out.println(obj_fetch_pick_vals.createOptionValues("g_pkl_languague","",db_name,insstalled_at));
		%>
	</SELECT>
...
<!--		<A id="PUB_LANGHLP" name="PUB_LANGHLP"  href="#" onClick="getPicklistValues('g_pkl_languague','PUB_LANG','','')" class="linkblue" >?</A> &nbsp; -->
	...
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="PUB_TYPE_label" class="userlabel"><%= field_labels.getString("MT_PUBLICATION.PUB_TYPE") %><SPAN class="instreditalic">*</SPAN></LABEL>
		</TD>
		<TD class="ste" colspan="2" nowrap>
<!--			<INPUT TYPE="text"  id="PUB_TYPE" name="PUB_TYPE" class="input" onChange="FieldValidation(this); getCodeDesc('PUB_TYPE','PUB_TYPEDESC', 'g_pkl_pubtypeDesc','KEY_CODE');" maxlength="10" value="<%=(String)MT_PUBLICATIONObj.get("PUB_TYPE") %>"> -->
		<SELECT class="input"name='PUB_TYPE' id="PUB_TYPE" onChange="FieldValidation(this);getCodeDesc('PUB_TYPE','PUB_TYPEDESC', 'g_pkl_pubtypeDesc','KEY_CODE');"  onBlur="FieldValidation(this);">
		<%
			l_selectedValue=(String)MT_PUBLICATIONObj.get("PUB_TYPE");
			out.println("<option value=''>Select</option>");
			out.println(obj_fetch_pick_vals.createOptionValues("g_pkl_pubtype","",db_name,insstalled_at));
		%>
	</SELECT>
...
<!--			<INPUT TYPE="text"  id="PUB_RUN" name="PUB_RUN" class="input" onChange="FieldValidation(this); getCodeDesc('PUB_RUN','PUB_RUNDESC', 'g_pkl_pubruntypeDesc','KEY_CODE');" maxlength="10" value="<%=(String)MT_PUBLICATIONObj.get("PUB_RUN")%>">
    -->
		<SELECT class="input"name='PUB_RUN' id="PUB_RUN" onChange="FieldValidation(this);getCodeDesc('PUB_RUN','PUB_RUNDESC', 'g_pkl_pubruntypeDesc','KEY_CODE');"  onBlur="FieldValidation(this);">
		<%
			l_selectedValue=(String)MT_PUBLICATIONObj.get("PUB_RUN");
			out.println("<option value=''>Select</option>");
			out.println(obj_fetch_pick_vals.createOptionValues("g_pkl_pubruntype","",db_name,insstalled_at));
		%>
	</SELECT>
	...
	<TR class="ste">
		...
		{
		%>
			<INPUT type="checkbox" id="PUB_DAYS<%=i%>" name="PUB_DAYS<%=i%>" class="userlabel" onblur="FieldValidation(this);" value="<%= g_days[i]%>"><%= g_days[i]%>&nbsp;&nbsp;
		<%
			}
		%>
		</TD>
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			...
			out.println("<option value=''>Select</option>");
			out.println(obj_fetch_pick_vals.createOptionValues("g_pkl_days1","",db_name,insstalled_at));
		%>
          </SELECT>
		...
		<TD class="ste" colspan="2" nowrap>
			...
			out.println("<option value=''>Select</option>");
			out.println(obj_fetch_pick_vals.createOptionValues("g_pkl_days2","",db_name,insstalled_at));
		%>
          </SELECT>
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
		<INPUT type="radio" id="PUB_DT_ALL_FLG" name="PUB_DT_ALL_FLG" checked onClick="FieldValidation(this);" value="Y" accessKey="Y" ><%= field_labels.getString("radio_yes") %>

		<INPUT type="radio" id="PUB_DT_ALL_FLG" name="PUB_DT_ALL_FLG"  onClick="FieldValidation(this);" value="N" accessKey="N" ><%= field_labels.getString("radio_no") %>
...
<!--	<TR class="ste">
		<TD   class="titlehead" colspan="5" nowrap>
			<LABEL ID="HEADER3"><%= field_labels.getString("MT_PUBLICATION.HEADER3") %></LABEL>
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="PUB_SIZEWIDTH_label" class="userlabel"><%= field_labels.getString("MT_PUBLICATION.PUB_SIZEWIDTH") %></LABEL>
		</TD>
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="PUB_SIZEWIDTH" name="PUB_SIZEWIDTH" class="input" size="6" onblur="FieldValidation(this);"  value="<%= (String)MT_PUBLICATIONObj.get("PUB_SIZEWIDTH") %>" >
		</TD>
		<TD class="ste" nowrap>   
			<LABEL ID="PUB_NOOFCOLS_label" class="userlabel"><%= field_labels.getString("MT_PUBLICATION.PUB_NOOFCOLS") %></LABEL>
		</TD>
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="PUB_NOOFCOLS" name="PUB_NOOFCOLS" class="input" size="3" onblur="FieldValidation(this);" maxLength="3"  value="<%= (String)MT_PUBLICATIONObj.get("PUB_NOOFCOLS") %>" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="PUB_SIZEHEIGHT_label" class="userlabel"><%= field_labels.getString("MT_PUBLICATION.PUB_SIZEHEIGHT") %></LABEL>
		</TD>
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="PUB_SIZEHEIGHT" name="PUB_SIZEHEIGHT" class="input" size="6" onblur="FieldValidation(this);"  value="<%= (String)MT_PUBLICATIONObj.get("PUB_SIZEHEIGHT") %>" >
		</TD>
		<TD class="ste" nowrap>   
			<LABEL ID="PUB_GUTTER_label" class="userlabel"><%= field_labels.getString("MT_PUBLICATION.PUB_GUTTER") %></LABEL>
		</TD>
				<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="PUB_GUTTER" name="PUB_GUTTER" class="input" size="6" onblur="FieldValidation(this);" maxLength="6"  value="<%= (String)MT_PUBLICATIONObj.get("PUB_GUTTER") %>" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="PUB_PRODDAYSBEF_label" class="userlabel"><%= field_labels.getString("MT_PUBLICATION.PUB_PRODDAYSBEF") %></LABEL>
		</TD>
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="PUB_PRODDAYSBEF" name="PUB_PRODDAYSBEF" class="input" size="25" onblur="FieldValidation(this);" maxLength="3"  value="<%= (String)MT_PUBLICATIONObj.get("PUB_PRODDAYSBEF") %>" >
			<%= field_labels.getString("MT_PUBLICATION.PUB_DAYSBEF") %>
		</TD>
	<TR class="ste">
    ...
    <TABLE class="eventstable" cellspacing="0" cellpadding="0">
     ...
     <TR class="eventsrow2"> 
      <TD class="eventscol" align="right">
		...
		<INPUT TYPE="button" id="GotoRate" value="AddRate"  class="button"  onClick="gotoRate()">
		<INPUT TYPE="button" id="GotoPurRate" value="AddPurRate"  class="button"  onClick="gotoPurRate()">
		<INPUT TYPE="button" id="GotoSupRate" value="AddSupRate"  class="button"  onClick="gotoSupRate()">
