...
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_ROUTE">
...
<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="ROUTE_CODE" name="ROUTE_CODE" class="input" size="10"  onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_ROUTEObj.get("ROUTE_CODE") %>">
		</TD>
		<TD class="ste"></TD>
	</TR>
...
<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="MAR_NAME" name="MAR_NAME" class="input" size="65"  onblur="FieldValidation(this);" maxLength="65"  value="<%= (String)MT_ROUTEObj.get("MAR_NAME") %>" >
		</TD>
		<TD class="ste"></TD>
	</TR>
<TR class="ste">
...
<TR class="ste">
		...
		<TD class="ste" nowrap>
			<INPUT type="text"  id="TRAN_MODE" name="TRAN_MODE" class="input" size="3" onChange="FieldValidation(this); getCodeDesc('TRAN_MODE','TRAN_MODEDESC', 'g_pkl_transportDesc','KEY_CODE')" Value= "<%=(String)MT_ROUTEObj.get("CMP_CODE")%>">
...
<TR class="ste">
	...
	<TD class="ste" colspan="2" nowrap>
		...
		<INPUT type="radio" id="VALID_FLG" name="VALID_FLG" checked onClick="FieldValidation(this);" value="Y" accessKey="Y" ><%= field_labels.getString("radio_yes") %>

		<INPUT type="radio" id="VALID_FLG" name="VALID_FLG"  onClick="FieldValidation(this);" value="N" accessKey="N" ><%= field_labels.getString("radio_no") %>
-->
	</TABLE>
     </TD>
	  </TR>
