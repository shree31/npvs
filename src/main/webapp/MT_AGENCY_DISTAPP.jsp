...
<SCRIPT Language='Javascript' type='text/javascript' src='scripts/convUnicode.js'> </SCRIPT>
...
function execute_onLoad()
{
	...
	document.getElementById("SUP_ST_DT").value = sys_date;
	document.getElementById("SEC_DED_TYPE").accessKey ="N";
	chkSecDedType(document.getElementById("SEC_DED_TYPE"));
...
{
/*		if(as_field_name.name=="AGN_MAR_NAME")
		{
			//alert(as_field_name.value);
					alert(translitword(as_field_name.value));			
		}
*/
...
<TR class="ste">
		...
		<TD class="ste" colspan="4" nowrap>
			<INPUT type="text" id="AGN_CODE" name="AGN_CODE" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_AGENCYObj.get("AGN_CODE") %>" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
	...
	<TR class="ste">
		...
		<TD class="ste"  nowrap>
			<INPUT type="text" id="AGN_MAR_NAME" name="AGN_MAR_NAME" class="marathi_script" size="65" onblur="FieldValidation(this);" maxLength="65"  value="<%= (String)MT_AGENCYObj.get("AGN_MAR_NAME") %>" >
		</TD>
		<TD class="ste">   
	...
	<TD class="ste" nowrap>
		...
		<INPUT type="radio" id="AGN_LBL_FLG" name="AGN_LBL_FLG" checked onClick="FieldValidation(this);" value="Y" accessKey="Y" ><%= field_labels.getString("radio_yes") %>

		<INPUT type="radio" id="AGN_LBL_FLG" name="AGN_LBL_FLG"  onClick="FieldValidation(this);" value="N" accessKey="N" ><%= field_labels.getString("radio_no") %>
	...
	<TR class="ste">
		...
		<TD class="ste" nowrap>
			<INPUT type="text" id="SUP_ST_DT" name="SUP_ST_DT" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_AGENCYObj.get("SUP_ST_DT") %>" >	<a href="#" onClick="javascript:calendar('SUP_ST_DT',event.screenY,event.screenX,null,null,getDatePickerPattern());"
		...
		<TD class="ste" nowrap>
			<INPUT type="text" id="SUS_DT" name="SUS_DT" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_AGENCYObj.get("SUS_DT") %>" > <a href="#" onClick="javascript:calendar('SUS_DT',event.screenY,event.screenX,null,null,getDatePickerPattern());"
			title="Select Date"> <img src="images/calendar.gif" width="16"
			height="16" border="0" /></a>
		</TD>
	</TR>
	<TR class="ste">
		...
		<TD class="ste" nowrap>
			<INPUT type="text" id="SUP_EN_DT" name="SUP_EN_DT" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_AGENCYObj.get("SUP_EN_DT") %>" > <a href="#" onClick="javascript:calendar('SUP_EN_DT',event.screenY,event.screenX,null,null,getDatePickerPattern());"
			title="Select Date"> <img src="images/calendar.gif" width="16"
			height="16" border="0" /></a>
		</TD>
		<TD class="ste" nowrap>   
		...
		<TD class="ste" nowrap>
			<INPUT type="text" id="REOPEN_DT" name="REOPEN_DT" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_AGENCYObj.get("REOPEN_DT") %>" > <a href="#" onClick="javascript:calendar('REOPEN_DT',event.screenY,event.screenX,null,null,getDatePickerPattern());"
			title="Select Date"> <img src="images/calendar.gif" width="16"
			height="16" border="0" /></a>
		</TD>
	</TR>
	...
	<TD class="ste" nowrap>
		...
		<INPUT type="radio" id="BILLABLE_FLG" name="BILLABLE_FLG" class="userlabel" checked onClick="FieldValidation(this);" value="Y" accessKey="Y" ><%= field_labels.getString("radio_yes") %>

		<INPUT type="radio" id="BILLABLE_FLG" name="BILLABLE_FLG"  class="input" onClick="FieldValidation(this);" value="N" accessKey="N" ><%= field_labels.getString("radio_no") %>
	...
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="BILL_FREQ_label" class="userlabel"><%= field_labels.getString("MT_AGENCY.BILL_FREQ") %><SPAN class="instreditalic">*</SPAN></LABEL>
		</TD>
		<TD class="ste" nowrap>
	...
	<TD class="ste" colspan="4" nowrap>
		...
		<INPUT type="radio" id="SEC_DED_FLG" name="SEC_DED_FLG" class="userlabel" onClick="FieldValidation(this);" value="Y" accessKey="Y" ><%= field_labels.getString("radio_yes") %>

		<INPUT type="radio" id="SEC_DED_FLG" name="SEC_DED_FLG"  class="input" checked onClick="FieldValidation(this);" value="N" accessKey="N" ><%= field_labels.getString("radio_no") %>
	...
	<TD class="ste" nowrap>
		...
		<INPUT type="radio" id="SEC_DED_TYPE" name="SEC_DED_TYPE" class="userlabel" checked onClick="FieldValidation(this);" value="P" accessKey="P" ><%= field_labels.getString("MT_AGENCY.SEC_DED_TYPE_Option1") %>

		<INPUT type="radio" id="SEC_DED_TYPE" name="SEC_DED_TYPE"  class="input" onClick="FieldValidation(this);" value="A" accessKey="A" ><%= field_labels.getString("MT_AGENCY.SEC_DED_TYPE_Option2") %>
