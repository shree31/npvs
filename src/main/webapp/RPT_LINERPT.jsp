...
{
	if(as_field_name.name=="DAYS" && as_field_name.value=="X")
		document.getElementById("RPT_ID").value="RP_LR_002";
	return true;
}
...
function preSubmit()
{
	createParamStr('ROUTE_CODE,CMP_CODE,DAYS,LANGUAGE,ALIGN');
	validateSubmit();
}
...
<INPUT type="hidden" id="PROCESS_NAME" name="PROCESS_NAME" value="LINE_RPT">
<INPUT type="hidden" id="RPT_ID" name="RPT_ID" value="RP_LR_001">
   ...
   <TABLE class="headertable" cellspacing="0" cellpadding="0" width='100%'>
        ...
        <TR> 
           <TD class="heading" nowrap align="center">
            <%= field_labels.getString("RPT_LINERPT.LINE_RPT") %>
           </TD>
           <TD>&nbsp;</TD>
        </TR>
   </TABLE>
 ...
 <TABLE class="detailstable" cellspacing="0" cellpadding="0">
	...
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="DAYS_label" class="userlabel"><%= field_labels.getString("RPT_ORDER.DAYS") %><SPAN class="instreditalic">*</SPAN></LABEL>
		</TD>
		<TD class="ste" colspan="7" nowrap>
			<SELECT id="DAYS" NAME="DAYS" onChange="FieldValidation(this)">
			<OPTION value="%%"> ALL</OPTION>
			<OPTION value="______Y">SUN</OPTION>
			<OPTION value="_______">MON-SAT</OPTION>
			<OPTION value="X">MON-SAT+SUN</OPTION>
			</SELECT>
		</TD>
	</TR>
	...
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="ALIGN_label" class="userlabel"><%= field_labels.getString("RPT_ORDER.ALIGN") %><SPAN class="instreditalic">*</SPAN></LABEL>
		</TD>
		<TD class="ste" colspan="7" nowrap>
...
<!--	<TR class="ste">
	...
	<TR class="ste">
	        <TD class="ste" nowrap>   
				<LABEL ID="ROUTE_CODE_label" class="userlabel"><%= field_labels.getString("RPT_ORDER.ROUTE_CODE") %><SPAN class="instreditalic">*</SPAN></LABEL>
