...
{
		if(document.getElementById("CMP_CODE").value!="" && document.getElementById("CNT_CODE").value!="" && document.getElementById("BILL_FREQ").value!="" && document.getElementById("MONTH").value!="" && document.getElementById("YEAR").value!="" )
		{
			var l_criteria=document.getElementById("CMP_CODE").value +'@'+ document.getElementById("CNT_CODE").value +'@'+ document.getElementById("BILL_FREQ").value +'@'+ document.getElementById("MONTH").value +'@'+ document.getElementById("YEAR").value;
			populateDropDownVals('g_pkl_dl_billDates','BILL_DATE',l_criteria);
...
function preSubmit()
{
	createParamStr('CMP_CODE,CNT_CODE,BILL_FREQ,BILL_DATE,AGN_CODE,AREA_CODE,ROUTE_CODE,CATEGORY_CODE');
	validateSubmit();
}
...
<INPUT type="hidden" id="RPT_ID" name="RPT_ID" value="RP_BI_004">
    ...
    <TABLE class="headertable" cellspacing="0" cellpadding="0" width='100%'>
        ...
        <TR> 
           <TD class="heading" nowrap align="center">
            <%= field_labels.getString("RPT_BILL.RPT_BILL_PRINT") %>
           </TD>
           <TD>&nbsp;</TD>
        </TR>
   </TABLE>
...
<!--	<TR class="ste">
	...
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="PRINT_TYPE_label" class="userlabel"><%= field_labels.getString("RPT_BILL.PRINT_TYPE") %><SPAN class="instreditalic">*</SPAN></LABEL>
		</TD>
		<TD class="ste" colspan="2" nowrap>
...
-->
	...
	(String)RPT_BILLObj.get("CNT_CODEDESC") %>" >
		...
		<TD class="ste" colspan="7" nowrap>
			<INPUT type="text" id="BILL_FREQ" name="BILL_FREQ" class="input" size="1"  onChange="FieldValidation(this);getCodeDesc('BILL_FREQ','BILL_FREQDESC', 'g_pkl_billfreqDesc','KEY_CODE');" maxLength="1"  value="D" >
	  <INPUT type="text" id="BILL_FREQDESC" name="BILL_FREQDESC" class="input" size="30" maxLength="30" value="DAILY" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
	...
	(String)RPT_BILLObj.get("PUB_CODEDESC") %>" >
		...
		<%
			...
			out.println(obj_fetch_pick_vals.createOptionValues("g_pkl_month","",db_name,insstalled_at));
		%>
		</SELECT> 
		</TD>
	</TR>
	...
	<TR class="ste">
		...
		<TD>
			...
			onChange="FieldValidation(this);getCodeDesc('AREA_CODE,CMP_CODE','AREA_NAME', 'g_pkl_areaDesc','');" >
