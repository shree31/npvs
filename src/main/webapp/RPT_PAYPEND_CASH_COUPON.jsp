...
<%
%>
<TITLE id="RPT_PAY_DTEAILS_title">Collection Pending</TITLE>
...
function preSubmit()
{
	createParamStr('CMP_CODE,AGN_CODE,CATEGORY_CODE,DLV_CODE,BUILD_NO,ROUTE_CODE,ASOF_DATE');
...
<INPUT type="hidden" id="RPT_ID" name="RPT_ID" value="RP_CCP_001">
   ...
   <TABLE class="headertable" cellspacing="0" cellpadding="0" width='100%'>
        ...
        <TR> 
           <TD class="heading" nowrap align="center">
            <%= field_labels.getString("RPT_PAYPEND_AMT.RPT_PAYPEND_AMT_title") %>
           </TD>
           <TD>&nbsp;</TD>
        </TR>
   </TABLE>
 ...
 <TABLE class="detailstable" cellspacing="0" cellpadding="0">
	<TR class="ste">
		...
		<TD class="ste" colspan="7" nowrap>
			<INPUT type="text" id="ASOF_DATE" name="ASOF_DATE" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)RPT_PAY_DTEAILSObj.get("ASOF_DATE") %>" ><a href="#" onClick="javascript:calendar('ASOF_DATE',event.screenY,event.screenX,null,null,getDatePickerPattern());"
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="DLV_CODE" name="DLV_CODE" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('DLV_CODE','DLV_CODEDESC','g_pkl_deliveryDesc','');" 
					maxLength="10" value="<%=(String) RPT_PAY_DTEAILSObj.get("DLV_CODE")%>" >
			<INPUT type="text" id="DLV_CODEDESC" name="DLV_CODEDESC" class="input" size="50" readonly  maxLength="50" value="<%=(String) RPT_PAY_DTEAILSObj.get("DLV_CODEDESC")%>" />
