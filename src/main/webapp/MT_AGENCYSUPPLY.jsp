...
//	String subGranted="";
	...
	if(g_subsapp_flg.equals("P"))
	{
		...
		if(l_agency_code!=null && l_new_entry.equals("N"))
		{
			...
			{
				String[] l_param_str_arr = null;
				if(request.getParameter("PARAM_STR")!=null)
				{
					l_param_str_arr = request.getParameter("PARAM_STR").toString().split("@");
			...
			if(request.getParameter("PARAM_STR")!=null)
				l_str_query = l_str_query + " AND S.PUB_CODE ='"+l_param_str_arr[1]+"'";
				...
				if(l_CUST_ADDRESS==null || l_CUST_ADDRESS=="")
					l_CUST_ADDRESS="";
			}
		}
...
//	document.getElementById("DAY1").value = l_base_val;
//	document.getElementById("DAY2").value = l_base_val;
//	document.getElementById("DAY3").value = l_base_val;
//	document.getElementById("DAY4").value = l_base_val;
//	document.getElementById("DAY5").value = l_base_val;
//	document.getElementById("DAY6").value = l_base_val;
//	document.getElementById("DAY7").value = l_base_val;
//	document.getElementById("DAY8").value = l_base_val;
//	document.getElementById("DAY9").value = l_base_val;
//	document.getElementById("DAY10").value = l_base_val;
//	document.getElementById("DAY11").value = l_base_val;
//	document.getElementById("DAY12").value = l_base_val;
//	document.getElementById("DAY13").value = l_base_val;
//	document.getElementById("DAY14").value = l_base_val;
//	document.getElementById("DAY15").value = l_base_val;
//	document.getElementById("DAY16").value = l_base_val;
//	document.getElementById("DAY17").value = l_base_val;
//	document.getElementById("DAY18").value = l_base_val;
//	document.getElementById("DAY19").value = l_base_val;
//	document.getElementById("DAY20").value = l_base_val;
//	document.getElementById("DAY21").value = l_base_val;
//	document.getElementById("DAY22").value = l_base_val;
//	document.getElementById("DAY23").value = l_base_val;
//	document.getElementById("DAY24").value = l_base_val;
//	document.getElementById("DAY25").value = l_base_val;
//	document.getElementById("DAY26").value = l_base_val;
//	document.getElementById("DAY27").value = l_base_val;
//	document.getElementById("DAY28").value = l_base_val;
//	document.getElementById("DAY29").value = l_base_val;
//	document.getElementById("DAY30").value = l_base_val;
//	document.getElementById("DAY31").value = l_base_val;
...
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_AGENCYSUPPLY">
...
%>
	<TR>
		<TD class="str" colspan=1>
		<A href="MT_AGENCYSUPPLYMODALL.jsp?AGN_CODE=<%=l_agency_code%>&PUB_CODE=<%=l_param_fld_vals[0].trim()%>" id="PUB_CODE<%=i%>" target="_self" class="linkblue" name="PUB_CODE<%=i%>"><%= l_param_fld_vals[0].trim() %></A>
		<INPUT type="text" id="PUB_NAME<%=i%>" name="PUB_NAME<%=i%>" class="input" size="25" maxLength="40" readonly value="<%= l_param_fld_vals[1].trim() %>" >
		</TD>
		<TD class="str" nowrap>
			<INPUT type="text" id="COPY<%=i%>" name="COPY<%=i%>" class="input" size="3" maxLength="3"  value="<%= l_param_fld_vals[2].trim() %>" >
		</TD>
		<TD class="str" nowrap>
			<INPUT type="text" id="COPY_START_DATE<%=i%>" name="COPY_START_DATE<%=i%>" class="input" size="10" maxLength="10"  value="<%= l_param_fld_vals[3].trim() %>" >
		</TD>
		<TD class="str" nowrap>
			<INPUT type="text" id="PUB_RUN<%=i%>" name="PUB_RUN<%=i%>" class="input" size="10" maxLength="10" readOnly value="<%= l_param_fld_vals[10].trim() %>" >
		</TD>
		...
		<TD class="str" nowrap>   
			<LABEL ID="PUB_DT<%=i%>_label" class="userlabel"><%= field_labels.getString("MT_PUBLICATION.PUB_DT") %></LABEL>
		
			<INPUT type="text" id="PUB_DT<%=i%>" name="PUB_DT<%=i%>" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%=l_param_fld_vals[15]%>" >
		...
		<TD class="str" nowrap>
			<INPUT type="text" id="PYMT_MODE<%=i%>" name="PYMT_MODE<%=i%>" class="input" size="6" maxLength="6"  value="<%= l_param_fld_vals[4] %>" >
		</TD>
		<TD class="str" nowrap>
			<INPUT type="text" id="COUPON_NO<%=i%>" name="COUPON_NO<%=i%>" class="input" size="20" maxLength="20"  value="<%= l_param_fld_vals[6] %>" >
		</TD>
		<TD class="str" nowrap>
			<INPUT type="text" id="CPN_ST_DT<%=i%>" name="CPN_ST_DT<%=i%>" class="input" size="10" maxLength="10"  value="<%= l_param_fld_vals[7].trim() %>" >
		</TD>
		<TD class="str" nowrap>
			<INPUT type="text" id="CPN_EN_DT<%=i%>" name="CPN_EN_DT<%=i%>" class="input" size="10" maxLength="10"  value="<%= l_param_fld_vals[8].trim() %>" >
		</TD>
		<TD class="str" nowrap>
			<INPUT type="text" id="AVD_COUPON<%=i%>" name="AVD_COUPON<%=i%>" class="input" size="10" maxLength="2"  value="<%= l_param_fld_vals[9].trim() %>" >
		</TD>
<%		if("Y".equals(g_comm_per_flag)){ %>
		<TD class="str" nowrap>
			<INPUT type="text" id="COMM_PER<%=i%>" name="COMM_PER<%=i%>" class="input" size="6" maxLength="6"  value="<%= l_param_fld_vals[13].trim() %>" >
		</TD>
<%		} %>
<%		if("Y".equals(g_sc_p_flag)){ %>
		<TD class="str" nowrap>
			<INPUT type="text" id="SERV_CHRG<%=i%>" name="SERV_CHRG<%=i%>" class="input" size="6" maxLength="6"  value="<%= l_param_fld_vals[14].trim() %>" >
		</TD>
<%		} %>
...
<%}}%>
	<TR>
		...
		%>
		<TD class="ste" nowrap>
		<select class="input"name='PUB_CODE' id="PUB_CODE" onChange="FieldValidation(this);getCodeDesc('PUB_CODE','PUB_NAME','g_pkl_publicationDesc','');populateRunType(this)"  onBlur="FieldValidation(this);">
		<%
...
<%} else {%>
		<TD class="ste" nowrap>
		<INPUT TYPE="text" class="input"name='PUB_CODE' id="PUB_CODE" value="" >
...
<TD class="ste" nowrap>
			<INPUT type="text" id="COPY" name="COPY" class="input" size="3" maxLength="3"  value="1"
			onChange="FieldValidation(this);" >
		</TD>
	
		<TD class="ste" nowrap>
			<INPUT type="text" id="COPY_START_DATE" name="COPY_START_DATE" onBlur="FieldValidation(this)" class="input" size="10" maxLength="10"  value="" >
		...
		<TD class="str" nowrap>
			<INPUT type="text" id="PUB_RUN" name="PUB_RUN" class="input" size="10" readOnly maxLength="10"  value="" >
		</TD>
		<TD class="ste" id="PUB_DAYS_D" nowrap>
		<%
		for(int j=0;j<g_days.length;j++)
		{
		%>
			<INPUT type="checkbox" id="PUB_DAYS<%=j%>" name="PUB_DAYS<%=j%>" class="userlabel" onClick="FieldValidation(this);" value="<%= g_days[j]%>"><%= g_days[j]%>&nbsp;&nbsp;
		<%
		}
		%>
		</TD>
		...
		<TD class="ste" nowrap id="PUB_DAYS_F" style="display:none">   
			<LABEL ID="PUB_DAY1_label" class="userlabel"><%= field_labels.getString("MT_PUBLICATION.PUB_DAY1") %></LABEL>
		
			<SELECT  id="PUB_DAY1" name="PUB_DAY1" class="input" onChange="FieldValidation(this);" >
           <OPTION value="0"><%= field_labels.getString("DefaultOption") %></OPTION>
		   ...
		   <OPTION value="15">15</OPTION>
			...
			<SELECT  id="PUB_DAY2" name="PUB_DAY2" class="input" onChange="FieldValidation(this);" >
           <OPTION value="0"><%= field_labels.getString("DefaultOption") %></OPTION>
		...
		<TD class="ste" nowrap id="PUB_DAYS_M" style="display:none">   
			<LABEL ID="PUB_DT_label" class="userlabel"><%= field_labels.getString("MT_PUBLICATION.PUB_DT") %></LABEL>
		
			<INPUT type="text" id="PUB_DT" name="PUB_DT" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="" >
		...
		<TD class="ste" nowrap>
		<select class="input"name='PYMT_MODE' id="PYMT_MODE" onChange="FieldValidation(this);"  onBlur="FieldValidation(this);">
		<%
			out.println("<option value=''>Select</option>");
			out.println("<option value='CASH'  selected>CASH</option>");
			out.println("<option value='COUPON'>COUPON</option>");
			//out.println(obj_fetch_pick_vals.createOptionValues("pay_mode",""));
		%>
	</SELECT>
</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="COUPON_NO" name="COUPON_NO" class="input" size="20" maxLength="20"  value=""
			onChange="FieldValidation(this);" >
		</TD>

		<TD class="ste" nowrap>
			<INPUT type="text" id="CPN_ST_DT" name="CPN_ST_DT" onBlur="FieldValidation(this)" class="input" size="10" maxLength="10"  value="" >
		...
		<TD class="ste" nowrap>
			<INPUT type="text" id="CPN_EN_DT" name="CPN_EN_DT" onBlur="FieldValidation(this)" class="input" size="10" maxLength="10"  value="" >
			<a id="CPN_EN_DTHLP" href="#" onClick="javascript:calendar('CPN_EN_DT',event.screenY,event.screenX,null,null,getDatePickerPattern());"
			title="Select Date"> <img src="images/calendar.gif" width="16"
			height="16" border="0" /></a>
		</TD>
		<TD class="ste" nowrap>
			<INPUT type="text" id="AVD_COUPON" name="AVD_COUPON" onBlur="FieldValidation(this)" class="input" size="10" maxLength="2"  value="" >
		</TD>
<%		if("Y".equals(g_comm_per_flag)){ %>
		<TD class="ste" nowrap>
			<INPUT type="text" id="COMM_PER" name="COMM_PER" class="input" size="6" maxlength="6" onblur="FieldValidation(this);" maxLength="6"  value="" >
		</TD>
		<% } %>
<%		if("Y".equals(g_sc_p_flag)){ %>
		<TD class="ste" nowrap>
			<INPUT type="text" id="SERV_CHRG" name="SERV_CHRG" class="input" size="6" maxlength="6" onblur="FieldValidation(this);" maxLength="6"  value="" >
		</TD>
		<% } %>
	</TR>
