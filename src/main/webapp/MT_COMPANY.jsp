...
function valuePopup(evt,depend)
{
	...
	if(key==113)
	{
		 ...
		 alert(id);
		var idLowerCase=document.activeElement.getAttribute('id').toLowerCase();
		 var arg="g_pkl_"+idLowerCase;
		getPicklistValues(arg,id,depend,'KEY_TYPE');
	}
}
...
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_COMPANY">
<INPUT type="hidden" id="ERRDESC" name="ERRDESC" value="<%=(String)MT_COMPANYObj.get("ERRDESC")%>">
<INPUT type="hidden" id="PARAM" name="PARAM" value="<%= (String)MT_COMPANYObj.get("PARAM") %>">
 ...
 <TABLE class="detailstable" cellspacing="0" cellpadding="0">
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="CMP_CODE" name="CMP_CODE" class="input" size="10" onblur="FieldValidation(this);" maxLength="10"  value="<%= (String)MT_COMPANYObj.get("CMP_CODE") %>" >
		</TD>
	</TR>
	<TR class="ste">
		<TD class="ste" nowrap>   
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="STATE" name="STATE" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('STATE,COUNTRY','STATEDESC','g_pkl_stateDesc','KEY_CODE,KEY_TYPE');" onKeyDown="valuePopup(event,'COUNTRY')" maxLength="10"  value="<%= (String)MT_COMPANYObj.get("STATE") %>" >
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="CITY" name="CITY" class="input" size="10" onChange="FieldValidation(this);getCodeDesc( 'CITY,STATE','CITYDESC','g_pkl_cityDesc','KEY_CODE,KEY_TYPE');" maxLength="10"  value="<%= (String)MT_COMPANYObj.get("CITY") %>" >
