...
function execute_onLoad()
{
	...
	document.getElementById("ENT_DATE").value = sys_date;
	document.getElementById("CHQ_DATE").value = sys_date;
...
function FieldValidation(as_field_name)
{
	...
	if (as_field_name.name =="AGN_CODE" && as_field_name.value!="")
...
//		alert(1);
		...
		setfldNonMandatory("CHQ_NO,CHQ_DATE,BANK_NAME");
	}
	else
	{
		...
		setfldMandatory("CHQ_NO,CHQ_DATE,BANK_NAME");
	}
}
...
<INPUT type="hidden" id="ENTITY" name="ENTITY" value="TR_PAY_DETAILS">
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="TR_PAY_DETAILS">
...
<INPUT type="hidden" id="PRIMARY_KEY" name="PRIMARY_KEY" value="RCD_NO">
...
<TR class="ste">
		...
		<TD>
			...
			onChange="FieldValidation(this);" value="<%= (String)TR_PAY_DETAILSObj.get("AGN_CODE")%>" >
		  <INPUT type="text" id="AGN_CODEDESC" name="AGN_CODEDESC" class="input" size="50" onBlur="FieldValidation(this);"  maxLength="50"  value="<%= (String)TR_PAY_DETAILSObj.get("AGN_CODEDESC") %>">
...
<!--	<TR class="str">
		...
		<TD>
		  ...
		  <INPUT type="text" id="CMP_CODEDESC" name="CMP_CODEDESC" class="input" size="50" maxLength="50"  value="<%= (String)TR_PAY_DETAILSObj.get("CMP_CODEDESC") %>" >
		</TD>
	</TR>
	...
	<TR class="str">
		...
		<TD>
			...
			onChange="FieldValidation(this);" >
		  <INPUT type="text" id="CNT_CODEDESC" name="CNT_CODEDESC" class="input" size="50"  readonly maxLength="50"  value="<%= (String)TR_PAY_DETAILSObj.get("CNT_CODEDESC") %>">
...
-->
	...
	<TR class="str">
	   <TD class="str" nowrap>   
		...
		<TD class="str" nowrap>
		<INPUT type="text" id="RCD_DATE" name="RCD_DATE" CLASS="input" size="10" readonly maxlength="10" value="">
		</TD>
	</TR>
	...
	<TR class="str">
	   <TD class="str" nowrap>   
		...
		<TD class="str" nowrap>
		<INPUT type="text" id="RCD_NO" name="RCD_NO" CLASS="input" size="25" readonly maxlength="25" value="<%= (String)TR_PAY_DETAILSObj.get("RCD_NO") %>">
		</TD>
	</TR>
	<TR class="ste">
	   <TD class="ste" nowrap>   
	...
	<TR class="ste">
		...
		<TD>
		  ...
		  <INPUT type="text" id="PYMT_TYPEDESC" name="PYMT_TYPEDESC" class="input" size="50"  readonly maxLength="50" value="<%= (String)TR_PAY_DETAILSObj.get("PYMT_TYPEDESC") %>" >
	...
	<TR class="ste">
		...
		<TD>
		  ...
		  <INPUT type="text" id="PYMT_MODEDESC" name="PYMT_MODEDESC" class="input" size="50"  readonly maxLength="50" value="<%= (String)TR_PAY_DETAILSObj.get("PYMT_MODEDESC") %>" >
	...
	<TR class="ste" colspan="1">
		...
		<a id="CHQ_DATEHLP" href="#" onClick="javascript:calendar('CHQ_DATE',event.screenY,event.screenX,null,null,getDatePickerPattern());"
			title="Select Date"> <img src="images/calendar.gif" width="16"
			height="16" border="0" /></a>
		</TD>
	</TR>
...
<INPUT TYPE="button" value="Submit" name="Submit_label" class="button" onClick="javascript:validateSubmit('Submit')">
