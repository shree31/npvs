...
function execute_onLoad()
{
	...
	if(document.getElementById("ERRDESC").value=="Details Not Available") {
			//document.getElementById("MODE").value='MOD';
		document.location.href="MT_SUPCHRGADD.jsp?MODE=MOD&PUB_CODE="+document.getElementById("PUB_CODE").value+"";
...
function populateRate() 
{
	...
	document.getElementById("SCREEN_NAME").value = "RATE_SUPVER";
...
function validateForm(as_event_label)
{
	...
	for(var i=1;i<32;i++) {
        ...
        document.getElementById("SCREEN_NAME").value = "MT_SUPCHRGVEW";
		document.getElementById("MODE").value = l_mode;
	document.getElementById("WK_SUP").value= document.getElementById("RATE1").value+"#"+ document.getElementById("RATE2").value+"#"+ document.getElementById("RATE3").value+"#"+ document.getElementById("RATE4").value+"#"+ document.getElementById("RATE5").value+"#"+ document.getElementById("RATE6").value+"#"+ document.getElementById("RATE7").value;
	validateSubmit();
	return true;
...
<INPUT type="hidden" id="ENTITY" name="ENTITY" value="MT_SUPCHRG">
...
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_SUPCHRGVEW">
...
<!--
	...
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="RATE_CODE_label" class="userlabel"><%= field_labels.getString("MT_RATE.RATE_CODE") %><SPAN class="instreditalic">*</SPAN></LABEL>
		</TD>
		<TD class="ste" colspan="7" nowrap>
	...
	<TR class="ste">
 	...
 	<TR class="ste">
		...
		<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="WEEKLY_RATE_label" class="userlabel"><%= field_labels.getString("MT_AGENCY.RATE_WEEKLY") %></LABEL>
		</TD>
     <TD class="ste" colspan="7" nowrap>
