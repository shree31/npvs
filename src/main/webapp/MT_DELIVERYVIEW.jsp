...
<%	
	...
	String formName = "MT_DELIVERYVIEW";
...
{
	document.getElementById("ENTITY").value="MT_DELIVERYVIEW";

	if(document.getElementById("MODE").value=="VIEW")
		document.getElementById("ENTITY").value="MT_DELIVERY";
	else
		clearNull();
}
...
<INPUT type="hidden" id="SCREEN_NAME" name="SCREEN_NAME" value="MT_DELIVERYVIEW">
...
<INPUT type="hidden" id="CITY" name="CITY" value="<%= (String)MT_DELIVERYObj.get("CITY") %>">
<INPUT type="hidden" id="AREA_CODE" name="AREA_CODE" value="<%= (String)MT_DELIVERYObj.get("AREA_CODE") %>">
<INPUT type="hidden" id="MAR_NAME" name="MAR_NAME" value="">
<INPUT type="hidden" id="OLD_CODE" name="OLD_CODE" value="">
<INPUT type="hidden" id="TYPE" name="TYPE" value="<%= (String)MT_DELIVERYObj.get("TYPE") %>">
 ...
 <TABLE class="detailstable" cellspacing="0" cellpadding="0">
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="DLV_CODE" name="DLV_CODE" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('DLV_CODE','NAME', 'g_pkl_deliveryDesc','')" maxLength="10"  value="<%= (String)MT_DELIVERYObj.get("DLV_CODE") %>" >
	...
	<TD class="ste" nowrap>   
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="TYPE" name="TYPE" class="input" size="10" readonly onChange="FieldValidation(this);getCodeDesc('TYPE','TYPEDESC','g_pkl_dlvtype','KEY_CODE');" maxLength="10"  value="<%= (String)MT_DELIVERYObj.get("TYPE") %>" >
	...
	<TR class="ste">
		...
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="AREA_CODE" name="AREA_CODE" class="input" size="10" onChange="FieldValidation(this);getCodeDesc('AREA_CODE','AREA_CODEDESC','g_pkl_areaDesc','');getCodeDesc( 'AREA_CODE','CITY','g_pkl_areacity','');" maxLength="10"  value="<%= (String)MT_DELIVERYObj.get("AREA_CODE") %>" >
	...
	<TR class="ste">
		<TD class="ste" nowrap>   
			<LABEL ID="CITY_label" class="userlabel"><%= field_labels.getString("MT_DELIVERY.CITY") %></LABEL>
		</TD>
		<TD class="ste" colspan="2" nowrap>
			<INPUT type="text" id="CITY" name="CITY" class="input" size="10" onChange="FieldValidation(this);getCodeDesc( 'CITY','CITYDESC','g_pkl_cityDesc','KEY_CODE');" maxLength="10"  value="<%= (String)MT_DELIVERYObj.get("CITY") %>" >
